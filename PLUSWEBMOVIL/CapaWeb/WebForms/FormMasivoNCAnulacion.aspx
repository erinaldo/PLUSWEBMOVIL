<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.Master" AutoEventWireup="true" CodeBehind="FormMasivoNCAnulacion.aspx.cs" Inherits="CapaWeb.WebForms.FormMasivoNCAnulacion" %>
      ...
      <form id="form1" class="forms-sample" runat="server" >
        <div style="align-items: center">
            <table>
                ...
                <tr>
                    <td colspan="3">
                        <asp:Label ID="lblAyuda" runat="server" CssClass="Titulo" Text="Importar Notas de Crédito por Anulación"></asp:Label>
