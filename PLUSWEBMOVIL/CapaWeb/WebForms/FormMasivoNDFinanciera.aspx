<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.Master" AutoEventWireup="true" CodeBehind="FormMasivoNDFinanciera.aspx.cs" Inherits="CapaWeb.WebForms.FormMasivoNDFinanciera" %>
    ...
    <form id="form1" class="forms-sample" runat="server" >
        ...
        <div style="align-items: center">
            <table>
                ...
                <tr>
                    <td colspan="3">
                        <asp:Label ID="lblAyuda" runat="server" CssClass="Titulo" Text="Importar Notas de Débito Financieras"></asp:Label>
                ...
                <tr>
                    <td >
                        <asp:Label ID="lbl_verificar" runat="server" Visible="false" CssClass="busqueda" Text="Total notas de débito a procesar:"></asp:Label>
                    </td>
                    <td>
