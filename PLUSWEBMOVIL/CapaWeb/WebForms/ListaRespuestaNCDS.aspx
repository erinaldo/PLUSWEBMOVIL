<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.Master" AutoEventWireup="true" CodeBehind="ListaRespuestaNCDS.aspx.cs" Inherits="CapaWeb.WebForms.ListaRespuestaNCDS" %>
          ...
          <div style="align-items: center">
            <table>
                <tr>
                   ...
                   <tr>
                    <td>
                        <asp:Label ID="Label1" CssClass="Subtitulo2" runat="server" Text="Estado Nota Crédito:"></asp:Label>
                        <asp:TextBox ID="txt_estado" CssClass="Subtitulo1" ReadOnly="true" runat="server" Width="216px"></asp:TextBox>
