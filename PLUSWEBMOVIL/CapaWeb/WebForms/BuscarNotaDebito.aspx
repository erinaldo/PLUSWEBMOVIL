            ...
            <table>
                 <tr>
                        <td valign="top">
                            <table width="100%" border="0" cellspacing="0">
                                <tr>
                                    <td class="nav">---&gt;<a href="<%Response.Write(Modelowmspclogo.sitio_app + "Menu_Ppal.asp"); %>">Menu Principal</a>---&gt;Nota de Débito</td>
                                </tr>
                            </table>
                        </td>
                ...
                <tr>
                    <td>
                        ...
                        <asp:Label ID="lblAyuda" runat="server"  CssClass="Titulo" Text="Notas de Débito"></asp:Label>
                        ...
                        <tr valign="top">
                          ...
                          <td>
                              <asp:DropDownList ID="cbx_tipo_factura" class="textos" runat="server" Height="16px" Width="204px">
                                  <asp:ListItem Value="NDVE">NOTA DÉBITO ELECTRÓNICA</asp:ListItem>
                                  <asp:ListItem Value="NDV">POR COMPUTADOR</asp:ListItem>
                              </asp:DropDownList>
                          </td>
