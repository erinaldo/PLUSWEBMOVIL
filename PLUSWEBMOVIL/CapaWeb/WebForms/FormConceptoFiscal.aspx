<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.Master" AutoEventWireup="true" CodeBehind="FormConceptoFiscal.aspx.cs" Inherits="CapaWeb.WebForms.FormConceptoFiscal" %>
                 ...
                 <tr>
                        <td valign="top">
                            <table width="100%" border="0" cellspacing="0">
                                <tr>
                                    <td class="nav">---&gt;<a href="<%Response.Write(Modelowmspclogo.sitio_app + "Menu_Ppal.asp"); %>">Menu Principal</a>---&gt;<a href="BuscarConceptoFiscal.aspx">Concepto Fiscal</a>---&gt;Nuevo</td>
                                </tr>
                            </table>
                        </td>
                ...
                <tr>
                    <td>
                        ...
                        <table align="center">
                            ...
                            <tr valign="top">
                                <td align="right" nowrap="nowrap" class="busqueda">
                                    <div align="left">Signo:</div>
                                </td>
                                <td>
                                     <asp:DropDownList ID="cbx_signo" class="textos" runat="server" required="required" Height="16px" Width="204px">
