...
{
    public partial class FormNotaDebitoAnulacion : System.Web.UI.Page
    {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (respuestaConfirmacionNC == "")
                            {
                                ...
                                ConsumoRestND consumoRest = new ConsumoRestND();
                                string respuesta = "";
                                respuesta = consumoRest.EnviarFactura(ComPwm, AmUsrLog, "C", "NDAE", conscabcera.nro_trans, txt_nro_trans_padre.Text);
                                if (respuesta == "")
                                {
