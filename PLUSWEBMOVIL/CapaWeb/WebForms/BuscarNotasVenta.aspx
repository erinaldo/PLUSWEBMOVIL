<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscarNotasVenta.aspx.cs" Inherits="CapaWeb.WebForms.BuscarNotasVenta" %>
...
<body>
    ...
    <div  align="center">
                        ...
                        <h2  class="Titulo">INGRESOS POR NOTAS DE VENTA</h2>
         ...
         <table style="width: 100%; text-align: right;">
                               <tr >
                                ...
                                <td valing="right" colspan="4">
                                    ...
                                    <asp:TextBox ID="txt_total_nv"  CssClass="textos"  ReadOnly ="true" runat="server"></asp:TextBox>
