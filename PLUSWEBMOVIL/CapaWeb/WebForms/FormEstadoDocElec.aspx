<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.Master" AutoEventWireup="true" CodeBehind="FormEstadoDocElec.aspx.cs" Inherits="CapaWeb.WebForms.FormEstadoDocElec" %>
                    ...
                    <td>
                        <table align="center" id="FormularioRes" runat="server" visible="False">
                            ...
                            <tr>
                                ...
                                <td align="right" nowrap="nowrap" class="busqueda">
                                    <div align="left">Estado Documento:</div>
                                </td>

                                <td>
                                    <asp:TextBox ID="txt_estado" CssClass="textos" runat="server" Width="212px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>

                                <td align="right" nowrap="nowrap" class="busqueda">
                                    <div align="left">Fecha operación:</div>
                                </td>

                                <td>
                                    <asp:TextBox ID="txt_operacion" CssClass="textos" runat="server" Width="212px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_email" CssClass="textos" runat="server" Width="212px"></asp:TextBox>
                                </td>
                            </tr>
