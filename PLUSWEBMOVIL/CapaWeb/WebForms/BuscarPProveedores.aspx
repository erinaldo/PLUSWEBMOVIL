<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscarPProveedores.aspx.cs" Inherits="CapaWeb.WebForms.BuscarPProveedores" %>
...
<body>
    ...
    <div  align="center">
                        ...
                        <h2  class="Subtitulo1">PAGO EN EFECTIVO DE FACTURAS</h2>
                            ...
                            <table border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#0E748A">
                                <tr>
                                    <td>
                                        ...
                                        CellPadding="4" BackColor="#DD6D29"  OnItemCommand="Grid_ItemCommand" DataKeyNames="nro_docum" 
