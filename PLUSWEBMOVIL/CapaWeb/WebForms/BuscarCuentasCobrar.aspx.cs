...
{
    public partial class BuscarCuentasCobrar : System.Web.UI.Page
    {
        ...
        public void RecuperarCokie()
        {
            try
            {
                ...
                {
                    empresa_codigo = Request.Cookies["AmComcod"].Value; //Empress del erp
                }
        ...
        public void GuardarExcepciones(string metodo, string error)
        {
            ...
            ModeloExcepcion.proceso = "BuscarCuentasCobrar.aspx";
