...
{
    public partial class FormNotaDebitoAnu : System.Web.UI.Page
    {
        ...
        public void GuardarExcepciones(string metodo, string error)
        {
            ...
            ModeloExcepcion.proceso = "FormNotaDebitoAnu.aspx";
        ...
        public void cargarListaDesplegables()
        {
            try
            {
                ...
                listaRes = ConsultaResolucion.ConsultaResolusionXSucursalND(AmUsrLog, ComPwm, ResF_estado, ResF_serie, ResF_tipo, "0");
        ...
        protected void LlenarFactura()
        {
            try
            {
                ...
                Session["Ccf_tipo2_NDA"] = conscabceraTipo.tipo_nce.Trim();
                lbl_tipo_nd.Text = conscabceraTipo.tipo_nce.Trim();
                listaConsCab = ConsultaCabe.ConsultaCabFacura(ComPwm, AmUsrLog, Ccf_tipo1, Session["Ccf_tipo2_NDA"].ToString(), Ccf_nro_trans, Ccf_estado, Ccf_cliente, Ccf_cod_docum, Ccf_serie_docum, Ccf_nro_docum, Ccf_diai, Ccf_mesi, Ccf_anioi, Ccf_diaf, Ccf_mesf, Ccf_aniof);
                conscabcera = null;
                foreach (modelowmtfacturascab item in listaConsCab)
                {
                    conscabcera = item;
        ...
        public void InsertarCabecera()
        {
            try
            {
                ...
                cabecerafactura.tipo = Session["Ccf_tipo2_NDA"].ToString();// "NCVE";
                ...
                cabecerafactura.mot_nce = "4"; //Motivo DS  4 por anulación
        ...
        protected void btn_Fac_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string tipo = Session["Ccf_tipo2_NDA"].ToString();
        ...
        public void EnviarCorreoRemitente(string nro_trans, string tipo)
        {
            try
            {
                ...
                string cod_proceso = "RCOMFELECT"; //van a usuar la misma de la factura
                                ...
                                if (conscabceraTipo.tipo_nce.Trim() == "NDVE")
                                {
                                    ...
                                    if (respuestaConfirmacionNC == "")
                                    {
                                        ...
                                        if (Modelowmspclogo.version_fe == "2")
                                        {
                                            ...
                                            respuesta = consumoRest.EnviarFactura(ComPwm, AmUsrLog, "C", conscabceraTipo.tipo_nce, conscabcera.nro_trans, txt_nro_trans_padre.Text);
                                        }
        ...
        public void EnviarCorreoCliente(string nro_trans, string tipo)
        {
            try
            {
                ...
                string cod_proceso = "RCOMFELECT"; //van a usuar la misma de la factura
                string pathPdf = generer_pdfElectronico.GenerarPDFNotaDebitoNormal(ComPwm, cod_proceso, AmUsrLog, Ccf_tipo1, Ccf_tipo2, Ccf_nro_trans);
        ...
        public Boolean ValidarFecha()
        {
            try
            {
                ...
                if (Session["Ccf_tipo2_NDA"].ToString() == "NDVE")
                {
