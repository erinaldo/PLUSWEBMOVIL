...
{
    public partial class BuscarConceptoFiscal : System.Web.UI.Page
    {
        ...
        private void CargarRolesUsuario()
        {
            try
            {
                ...
                string nuevo = roles.RespuestaRolNuevo(AmUsrLog, ComPwm);
                ...
                string acceso = roles.RespuestaRolAcceso(AmUsrLog, ComPwm);
                if (acceso == null)
                {
                    txtAcceso.Visible = true;
                }
                //Rol editar factura
                string editar = roles.RespuestaRolActualizar(AmUsrLog, ComPwm);
                ...
                string eliminar = roles.RespuestaRolEliminar(AmUsrLog, ComPwm);
        ...
        public void GuardarExcepciones(string metodo, string error)
        {
            ...
            ModeloExcepcion.proceso = "BuscarConceptoFiscal.aspx";
            ...
            try
            {
                ...
                switch (e.CommandName) //ultilizo la variable para la opcion
                {
                    ...
                    case "Editar": //ejecuta el codigo si el usuario ingresa el numero 1
                        try
                        {
                            Id = Convert.ToString(((Label)e.Item.Cells[1].FindControl("cod_concepto_fis")).Text);

                            //2 voy a agregando los valores que deseo
                            qs.Add("TRN", "UDP");
                            qs.Add("Id", Id.ToString());

                            Response.Redirect("FormConceptoFiscal.aspx" + Encryption.EncryptQueryString(qs).ToString());
