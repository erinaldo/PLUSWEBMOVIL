<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.Master" AutoEventWireup="true" CodeBehind="BuscarDatosFacturacion.aspx.cs" Inherits="CapaWeb.WebForms.BuscarDatosFacturacion" %>
                 ...
                 <tr>
                        <td valign="top">
                            <table width="100%" border="0" cellspacing="0">
                                <tr>
                                    <td class="nav">---&gt;<a href="<%Response.Write(Modelowmspclogo.sitio_app + "Menu_Ppal.asp"); %>">Menu Principal</a>---&gt;Parámetros Facturación</td>
                                </tr>
                            </table>
                        </td>
                  ...
                  <tr>
                    <td>
                        <p class="Subtitulo2"> Parámetros Facturación</p>
                        </td>
                    </tr>
                       <tr>
                    <td>
                  ...
                  <tr>
                    <td>
                        <p class="Subtitulo2">Para agregar nuevo Concepto de Facturación
                                    ...
                                    <asp:DataGrid ID="Grid" runat="server" onrowcreated="GriTipoUsuario_RowCreated"
                                        ...
                                        <Columns>
                                            <asp:TemplateColumn HeaderText="CÓDIGO" >
                                                <ItemTemplate>
                                                    <span style="float: left;">
                                                        <asp:Label ID="cod_concepto" CssClass="textos" runat="server" Text='<%#Eval("cod_concepto") %>'></asp:Label>
                                                    </span>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            ...
                                            <asp:TemplateColumn HeaderText="NOMBRE">
                                                <ItemTemplate>
                                                    <span style="float: left;">
                                                        <asp:Label ID="nom_concepto" CssClass="textos"  runat="server" Text='<%#Eval("nom_concepto") %>'></asp:Label>
                                                    </span>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
                                            ...
                                            <asp:TemplateColumn HeaderText="PORCENTAJE">
                                                <ItemTemplate>
                                                    <span style="float: left;">
                                                        <asp:Label ID="descuento" CssClass="textos"  runat="server" Text='<%#Eval("descuento") %>'></asp:Label>
                                                    </span>
                                                </ItemTemplate>
                                            </asp:TemplateColumn>
