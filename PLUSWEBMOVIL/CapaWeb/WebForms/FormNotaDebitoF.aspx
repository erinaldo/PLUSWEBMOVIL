<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.Master" AutoEventWireup="true" CodeBehind="FormNotaDebitoF.aspx.cs" Inherits="CapaWeb.WebForms.FormNotaDebitoF" %>
      ...
      <form id="form1" class="forms-sample" runat="server" method="post">
        ...
        <div style="align-items: center">
            <table>
                ...
                <tr>
                    <td valing="center">
                        <p class="Subtitulo2" >Nota de Débito por: Devolución de parte de los bienes; no aceptación de partes del servicio</p>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <table align="center">
                           ...
                           <tr>
                               ...
                               <td>
                                   <asp:Button ID="btn_Fac" onclick="btn_Fac_Click" CssClass="botones"  Width="164px" runat="server" Text="Buscar Nota Crédito" />
                                  </td>
                               <td class="busqueda">
