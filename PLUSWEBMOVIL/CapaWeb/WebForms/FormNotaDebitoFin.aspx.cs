    ...
    public partial class FormNotaDebitoFin : System.Web.UI.Page
    {
        ...
        public void CargarCamposFactura(string trx_factura)
        {
...

            {
                ...
                ListaSaldoFacturas = consultaSaldoFactura.BuscartaFacturaSaldos(AmUsrLog, ComPwm, conscabcera.cod_cliente, "C", "N", lbl_cod_suc_emp.Text.Trim(), fecha.Text, fecha.Text, "0");
            }
