...
namespace CapaWeb.WebForms
{
    public partial class BuscarNotaDebito : System.Web.UI.Page
    {
        ...
        public void GuardarExcepciones(string metodo, string error)
        {
            ...
            ModeloExcepcion.proceso = "BuscarNotaDebito.aspx";
                        ...
                        try
                        {
                            ...
                            switch (estadoM)
                            {
                                case "PENDIENTE":
                                    ...
                                    break;
                                default:
                                    this.Page.Response.Write("<script language='JavaScript'>window.alert('SU NOTA DE DÉBITO ESTA " + estadoM + ", NO SE PUEDE EDITAR.')+ error;</script>");
                                    break;
                            }
                        ...
                        try
                        {
                            ...
                            switch (estadoM)
                            {
                                case "CONTABILIZADO":
                                    ...
                                    this.Page.Response.Write("<script language='JavaScript'>window.alert('LA  NOTA DE DÉBITO ESTÁ EN ESTADO " + estadoM + ", NO SE PUEDE ELIMINAR.')+ error;</script>");
                                    break;
                                case "FINALIZADO":
        ...
        protected void btn_FinancieraND_Click(object sender, EventArgs e)
        {
            try
            {
                lbl_error.Text = "";
