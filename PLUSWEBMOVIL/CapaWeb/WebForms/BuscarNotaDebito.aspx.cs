...
{
    public partial class BuscarNotaDebito : System.Web.UI.Page
    {
        ...
        protected void btn_AnularNC_Click(object sender, EventArgs e)
        {
            ...
            qs.Add("TRN", "INS");
            qs.Add("Id", "");
            Response.Redirect("FormNotaDebitoAnulacion.aspx" + Encryption.EncryptQueryString(qs).ToString());
        }

        protected void btn_DevolucionNC_Click(object sender, EventArgs e)
        {
            //1 primero creo un objeto Clave/Valor de QueryString 
            QueryString qs = new QueryString();
            ...
            qs.Add("TRN", "AFA");
            qs.Add("Id", "");
            Response.Redirect("FormNotaDebitoF.aspx" + Encryption.EncryptQueryString(qs).ToString());
        }
        private void CargarRolesUsuario()
        {
            ...
            if (count1 > 0)
            {
                btn_AnularNC.Visible = true;
                btn_DevolucionNC.Visible = true;
                ...
                case "Eliminar":
                    ...
                    switch (estadoM)
                    {
                        case "CONTABILIZADO":
                            ...
                            this.Page.Response.Write("<script language='JavaScript'>window.alert('LA  NOTA DE DÉBITO ESTA EN ESTADO " + estadoM + " ')+ error;</script>");
                            break;
                        case "FINALIZADO":

                            this.Page.Response.Write("<script language='JavaScript'>window.alert('LA  NOTA DE DÉBITO EN ESTADO " + estadoM + " ')+ error;</script>");
                            break;
                        default:
                ...
                case "Reenviar":
                    ...
                    switch (estadoM)
                    {
                        case "CONTABILIZADO":
                            ...
                            qs.Add("Id", Id.ToString());
                            Response.Redirect("ReenviarNotaDebitoJson.aspx" + Encryption.EncryptQueryString(qs).ToString());
                            break;
                        default:
                            this.Page.Response.Write("<script language='JavaScript'>window.alert('SU NOTA DÉBITO ESTA " + estadoM + "')+ error;</script>");
                            break;
