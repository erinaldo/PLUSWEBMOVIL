...
{
    public partial class FormExcepciones : System.Web.UI.Page
    {
        ...
        public void GuardarExcepciones(string metodo, string error)
        {
            ...
            ModeloExcepcion.proceso = "FormExcepciones.aspx";
        ...
        private void CargarFormulario(string nro_trans)
        {
            try
            {
                lbl_error.Text = "";

                listaExcepciones = consultaExcepcion.ListaExcepcionPorID(ComPwm, nro_trans, AmUsrLog);
              
                foreach (var item in listaExcepciones)
                {
                    ModeloExcepcion = item;
                ...
                txt_error.Text = ModeloExcepcion.error;
