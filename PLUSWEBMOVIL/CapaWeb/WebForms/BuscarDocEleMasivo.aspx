<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site.Master" AutoEventWireup="true" CodeBehind="BuscarDocEleMasivo.aspx.cs" Inherits="CapaWeb.WebForms.BuscarDocEleMasivo" %>
...
function enviado() {
    if (cuenta == 0) {
        ...
        alert("Descarga de documentos ya empezo, espere por favor.");
        return false;
    }
}
</script>
            ...
            <table>
                 <tr>
                        <td valign="top">
                            <table width="100%" border="0" cellspacing="0">
                                <tr>
                                    <td class="nav">---&gt;<a href="<%Response.Write(Modelowmspclogo.sitio_app + "Menu_Ppal.asp"); %>">Menu Principal</a>---&gt;Documentos Comerciales</td>
                                </tr>
                            </table>
                        </td>
                ...
                <tr>
                    <td>
                        ...
                        <asp:Label ID="lblAyuda" runat="server"  CssClass="Titulo" Text="Descargar Documentos Comerciales"></asp:Label>
                ...
                <tr>
                  ...
                  <tr>
                    <td>
                        <asp:Label ID="lbl_fac_txt" CssClass="busqueda" Visible="false" runat="server" Text="Total documentos a descargar: "></asp:Label>
