<%@ Page Title="" Language="C#" MasterPageFile="~/WebForms/Site1.Master" AutoEventWireup="true" CodeBehind="FormNotaDebitoAnu.aspx.cs" Inherits="CapaWeb.WebForms.FormNotaDebitoAnu" %>
        ...
        <div style="align-items: center">
            <table>
                ...
                <tr>
                   ...
                   <tr>
                    <td>
                         <asp:Label ID="Label10" runat="server"  CssClass="Subtitulo2" Text="Sucursal: "></asp:Label>
                        ...
                        <table align="center">
                           ...
                           <tr>
                             ...
                             <tr>
                                ...
                                <td valign="top">
                                    <label>
                                       <asp:Label ID="lbl_tipo_nd" class="textos"  Width="202" ReadOnly="true" runat="server"></asp:Label>
                ...
                <tr>
                    <td>
                        ...
                        <table border="0" id="AgregarObservacion" style="visibility: hidden" align="center" >
                            ...
                            <tr>
                               <td>
                                       <asp:TextBox ID="txt_Codigo" CssClass="textos" size="20" MaxLength="50" runat="server"></asp:TextBox>
                                </td>
                                <td >
                                    <asp:TextBox ID="txt_Descripcion" CssClass="textos" Size="40" runat="server"></asp:TextBox>
                                 </td>
                                <td>
                                 ...
                                 <td>
                                    <asp:TextBox ID="txt_Iva" CssClass="textos" type="number"  Width="60px" runat="server"></asp:TextBox>
