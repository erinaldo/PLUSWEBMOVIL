<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscarProformasM.aspx.cs" Inherits="CapaWeb.WebForms.BuscarProformasM" %>
               ...
               <tr>
                ...
                <tr>
                    <td>
                        ...
                        <div class="Subtitulo1">Listado de Pedidos</div>
                    </td>
                </tr>
                                       ...
                                       <asp:DataGrid ID="Grid" runat="server" onrowcreated="GriTipoUsuario_RowCreated"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderText="DOCUMENTO">
                                                <ItemTemplate>
                                                    <span style="float: left;">
                                                        <asp:Label ID="descripcion" runat="server" class="textos" Text='<%#Eval("proformas") %>'></asp:Label>
                                                    </span>
                                                </ItemTemplate>
