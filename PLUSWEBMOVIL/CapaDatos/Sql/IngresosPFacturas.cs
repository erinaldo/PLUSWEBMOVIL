   ...
   public class IngresosPFacturas
    {
        ...
        public List<modeloIngresoFacturas> ListaPgsFacEfectivo( string cod_emp, string fec_doc)
        {
            ...
            catch (Exception e)
            {
                ...
                guardarExcepcion.ClaseInsertarExcepcion(cod_emp, "IngresosPFacturas.cs", "ListaPgsFacEfectivo", e.ToString(), DateTime.Today, "consulta");
                return null;
            }
        ...
        public List<modeloIngresoFacturas> ListaNotasVenta(string cod_emp, string fec_doc)
        {
            ...
            catch (Exception e)
            {
                ...
                guardarExcepcion.ClaseInsertarExcepcion(cod_emp, "IngresosPFacturas.cs", "ListaNotasVenta", e.ToString(), DateTime.Today, "consulta");
                return null;
            }
