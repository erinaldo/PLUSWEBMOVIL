   ...
   public  class SaldosFacturas
    {
        ...
        //Saldos y totales de facturas en general sin restricciones FILTRO POR FECHA UNICAMENTE
        public List<modeloSaldosFacturas> ConsultaFacturasSaldosXNroDocum(string Ccf_usuario, string Ccf_cod_emp, string Ccf_tipo1, string Ccf_tipo2, string solo_saldo, string nro_docum)
        {
            try
            {
            ...
            catch (Exception e)
            {
                ...
                guardarExcepcion.ClaseInsertarExcepcion(Ccf_cod_emp, metodo, "ConsultaFacturasSaldosXNroDocum", e.ToString(), DateTime.Now, Ccf_usuario);
                return null;
            }
