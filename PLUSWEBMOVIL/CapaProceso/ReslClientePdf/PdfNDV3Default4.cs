...
namespace CapaProceso.GenerarPDF.FacturaElectronica
{
    public class PdfNDV3Default4
    {
        ...
        string metodo = "PdfNDV3Default4.cs";
        ...
        public string generarPdf(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans)
        {
            try
            {
                ...
                foreach (modelowmtfacturascab item in listaConsCabTipo)
                {
                 ...
                 Tipo = conscabceraTipo.tipo_nce.Trim();
                if (Tipo == "VTA" || Tipo == "POS")
                {
                    documento_apli = "Factura";
                }
                else { documento_apli = "Nota Crédito"; }
                ...
                listaRes = ConsultaResolucion.ConsultaResolusiones(Ccf_usuario, Ccf_cod_emp, "0", conscabcera.serie_docum, "D");
                resolucion = null;
                ...
                string bpathPdfGenrado = pathtmpfac + Ccf_cod_emp.Trim() + Ccf_nro_trans.Trim() + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Second.ToString() + "ndebito.pdf";
             ...
             //   pw.PageEvent = new HeaderFooter();
                ...
                cell = new PdfPCell(new Phrase("Resolución Nota Débito N°." + resolucion.cod_atrib1, fontText4)); //7 tamaño
                cell.Border = 0;
                ...
                cell = new PdfPCell(new Phrase("NOTA DÉBITO ", titulo1));
                ...
                cell = new PdfPCell(new Phrase("Nro. " + resolucion.prefijo.Trim() + " - " + conscabcera.nro_docum, titulo1));
                ...
                cell = new PdfPCell(new Paragraph("FECHA GENERACIÓN: " + fecha_gene, fontText3)); //LETRA 8
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 1;
                cell.BorderWidthLeft = 1;
                cell.BorderWidthBottom = 1;
                ...
                cell = new PdfPCell(new Paragraph("Cliente:", fontText3));
                cell.BorderWidthTop = 1;
                ...
                cell = new PdfPCell(new Paragraph("Dirección:", fontText3));
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 0;
                cell.BorderWidthLeft = 1;
                cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph(documento_apli + " a aplicar:", fontText3));
                cell.BorderWidthTop = 1;
                cell.BorderWidthRight = 0;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph("Fecha " + documento_apli + " a aplicar:", fontText3));
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 0;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph(conscabceraNC.fec_doc_str, fontText3));
                cell.BorderWidthTop = 1;
                cell.BorderWidthRight = 1;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph(conscabceraNC.observacion, fontText3));
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 1;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthBottom = 0;
               ...
               // total1.SpacingAfter = 10;
                ...
                if (ListaModeloimpuesto.Count == 0)
                {
                    total1.DefaultCell.HorizontalAlignment = 0; total1.AddCell(new Paragraph(" "));
                    total1.DefaultCell.HorizontalAlignment = 2; total1.AddCell(new Paragraph(" "));
                    total1.DefaultCell.HorizontalAlignment = 2; total1.AddCell(new Paragraph(" "));
                    total1.DefaultCell.HorizontalAlignment = 2; total1.AddCell(new Paragraph(" "));
                }
                ...
                cell = new PdfPCell(new Paragraph("TOTAL NOTA DÉBITO:", titulo2));
                cell.BorderWidthBottom = 1;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 1;
    ...
    public  class HeaderFooter: PdfPageEventHelper
        ...
        public string ImagenQR(string qrPath, string Ccf_nro_trans)
        {
            ...
            catch (Exception e)
            {
                ...
                guardarExcepcion.ClaseInsertarExcepcion(nro_trans, metodo, "ImagenQR", e.ToString(), DateTime.Now, "consulta");
        ...
        public modelowmspctctrxCotizacion BuscarCotizacion(string usuario, string empresa,string nro_trans)
        {
            ...
            catch (Exception e)
            {
                ...
                guardarExcepcion.ClaseInsertarExcepcion(empresa, metodo, "BuscarCotizacion", e.ToString(), DateTime.Now, usuario);
                return null;
            }
        }
        ...
        public modelobancos BuscarBancos(string empresa, string usuario,  string banco, string tipo, string cuenta, string imprime)
        {
            ...
            catch (Exception e)
            {
                ...
                guardarExcepcion.ClaseInsertarExcepcion(empresa, metodo, "BuscarBancos", e.ToString(), DateTime.Now, usuario);
                return null;
            }
        }
        public modeloparametrocomercial BuscarParametro(string empresa)
        {
            ...
            catch (Exception e)
            {
                ...
                guardarExcepcion.ClaseInsertarExcepcion(empresa, metodo, "BuscarParametro", e.ToString(), DateTime.Now, "consulta");
                return null;
            }
        }
