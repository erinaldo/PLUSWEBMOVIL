...
{
   public  class JsonFacElecVer2PDF
    {
        ...
        string metodo = "JsonFacElecVer2PDF.cs";
        public JsonFacturaElecVer2 RespuestaJSONPdf(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans, string pdfbase64)
        {
            try
            {
                JsonFacturaElecVer2 jsonPdf = new JsonFacturaElecVer2();
        ...
        public EncabezadoFEV2 LlenarEnacabezadoPdfJSON(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans, string pdfbase64)
        {
            try
            {
                EncabezadoFEV2 encabezado = new EncabezadoFEV2();
