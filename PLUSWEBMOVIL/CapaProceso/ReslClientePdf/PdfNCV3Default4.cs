...
namespace CapaProceso.GenerarPDF.FacturaElectronica
{
    public class PdfNCV3Default4
    {
        ...
        string metodo = "PdfNCEleV3Default4.cs";
        ...
        public string generarPdf(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans)
        {
            try
            {
             ...
             //   pw.PageEvent = new HeaderFooter();
                ...
                cell = new PdfPCell(new Phrase("Resolución Nota Crédito N°." + resolucion.cod_atrib1, fontText4)); //7 tamaño
                cell.Border = 0;
                ...
                cell = new PdfPCell(new Phrase("NOTA CRÉDITO ", titulo1));
