    ...
    public class PdfFacVTAV5
    {
        ...
        public string generarPdf(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans)
        {
            try
            {
                ...
                cell = new PdfPCell(new Paragraph("FECHA GENERACIÓN: " + fecha_gene, fontText2)); //LETRA 8 FECHA HORA AUTORIZACION DIAN
                cell.Border = 0;
