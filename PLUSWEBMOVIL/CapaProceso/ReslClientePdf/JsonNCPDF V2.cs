...
namespace CapaProceso.ReslClientePdf
{
    public class JsonNCPDFV2
    {
        ...
        string metodo = "JsonNCPDFV2.cs";
        public JsonPdfNCV2 RespuestaJSONPdf(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans, string pdfbase64)
        {
            try
            {
                JsonPdfNCV2 jsonPdf = new JsonPdfNCV2();
                EncabezadoNCRV2 encabezado = new EncabezadoNCRV2();
                DocumentoNCRV2 documento = new DocumentoNCRV2();
        ...
        public EncabezadoNCRV2 LlenarEnacabezadoPdfJSON(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans, string pdfbase64)
        {
            try
            {
                EncabezadoNCRV2 encabezado = new EncabezadoNCRV2();
