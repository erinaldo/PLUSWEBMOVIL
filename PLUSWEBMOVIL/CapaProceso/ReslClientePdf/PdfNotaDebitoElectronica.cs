...
{
    public class PdfNotaDebitoElectronica
    {
        ...
        public string generarPdf(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans)
        {
            ...
            //Buscar datos de LA NC Y EL TIPO

            //CABECERA NC
            conscabceraNC = null;
            conscabceraNC = buscarCabezeraNC(Ccf_cod_emp, Ccf_usuario, Ccf_tipo1, "NC", conscabceraNCMot.nro_trans_padre.Trim());
            ...
            cell = new PdfPCell();
            cell = new PdfPCell(new Paragraph("NOTA DE DÉBITO ELECTRÓNICA  " + conscabcera.serie_docum + " - " + conscabcera.nro_docum, fontText));
            cell.Colspan = 3;
            cell.Border = 0;
            ...
            cell = new PdfPCell(new Paragraph("FECHA NDE: " + conscabcera.fec_doc_str, fontText));
            cell.BorderWidthBottom = 0;
            cell.BorderWidthLeft = 0;
            cell.BorderWidthTop = 0;
            cell.BorderWidthRight = 1;
            ...
            cell = new PdfPCell(new Paragraph("NOTA CRÉDITO A APLICAR: " + conscabceraNC.observacion, fontText));
            cell.BorderWidthBottom = 0;
            cell.BorderWidthLeft = 0;
            cell.BorderWidthTop = 0;
            cell.BorderWidthRight = 1;
            ...
            cell = new PdfPCell(new Paragraph("FECHA NOTA CRÉDITO A APLICAR: " + conscabceraNC.fec_doc_str, fontText));
            cell.BorderWidthBottom = 0;
            cell.BorderWidthLeft = 0;
            cell.BorderWidthTop = 0;
            cell.BorderWidthRight = 1;
            ...
            cell = new PdfPCell(new Paragraph("Prefijo " + conscabcera.mes_char + " " + "Nota Débito " + conscabcera.ntipo, fontText));
            cell.BorderWidthBottom = 0;
            cell.BorderWidthLeft = 0;
            cell.BorderWidthTop = 0;
            cell.BorderWidthRight = 1;
