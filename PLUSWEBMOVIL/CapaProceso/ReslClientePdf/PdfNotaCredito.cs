   ...
   public  class PdfNotaCredito
    {
        ...
        string metodo = "PdfNotaCredito.cs";
        ...
        public string generarPdf(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans)
        {
            try
            {
                ...
                //CABECERA NC
                conscabceraNC = null;
                conscabceraNC = buscarCabezeraNC(Ccf_cod_emp, Ccf_usuario, Ccf_tipo1, conscabceraTipo.tipo_nce.Trim(), conscabceraNCMot.nro_trans_padre.Trim());
