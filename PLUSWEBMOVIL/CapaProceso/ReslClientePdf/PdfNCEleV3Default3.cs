...
{
    public class PdfNCEleV3Default3
    {
        ...
        string metodo = "PdfNCEleV3Default3.cs";
        ...
        public string generarPdf(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans)
        {
            try
            {
                ...
                if (Modeloempresa.nro_dgi2.Trim() == "52899703")
                {
             ...
             //   pw.PageEvent = new HeaderFooter();
                ...
                cell = new PdfPCell(new Phrase("Resolución Nota Crédito Electrónica N°." + resolucion.cod_atrib1, fontText4)); //7 tamaño
                cell.Border = 0;
                ...
                cell = new PdfPCell(new Phrase("NOTA CRÉDITO ELECTRÓNICA ", titulo1));
                ...
                cell = new PdfPCell(new Phrase("Nro. " + resolucion.prefijo + " - " + conscabcera.nro_docum, titulo1));
                ...
                cell = new PdfPCell(new Paragraph("Fecha Factura a aplicar:", fontText3));
                cell.BorderWidthTop = 1;
                cell.BorderWidthRight = 0;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph("Factura a aplicar:", fontText3));
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 0;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthBottom = 0;
               ...
               // total1.SpacingAfter = 10;
                ...
                cell = new PdfPCell(new Paragraph("TOTAL NOTA CRÉDITO:", titulo2));
                cell.BorderWidthBottom = 1;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 1;
                ...
                cell = new PdfPCell(new Paragraph("Nota de Crédito emitida por Factura1 SAS, NIT:900875062-6   Software: SDB-F1 ", fontText2));
                cell.Border = 0;
                cell.HorizontalAlignment = 0;
                infotri1.AddCell(cell);
