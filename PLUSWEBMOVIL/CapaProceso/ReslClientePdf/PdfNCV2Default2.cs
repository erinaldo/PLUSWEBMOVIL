            ...
            try
            {
             ...
             //   pw.PageEvent = new HeaderFooter();
               ...
               // cell.Colspan = 2;
                ...
                cell = new PdfPCell(new Phrase("NOTA CRÉDITO",tipo1));
               ...
               // cell.Colspan = 2;
                ...
                iTextSharp.text.Image imagen_logo2 = iTextSharp.text.Image.GetInstance(pathLogo);
                imagen_logo2.BorderWidth = 0;
                imagen_logo2.Alignment = Element.ALIGN_LEFT;
                float percentages = 0.0f;
                percentage = 150 / imagen_logo2.Width;
                imagen_logo2.ScalePercent(percentage * 80);
                ...
                PdfPTable table_dian = new PdfPTable(1);//cantidad de columnas que va tener la tabla
                table_dian.WidthPercentage = 100;
                table_dian.SpacingAfter = 10;
                cell = new PdfPCell();
                ...
                cell = new PdfPCell(new Paragraph("Cliente:       "+ conscabcera.nom_tit, fontText1));
                cell.BorderWidthTop = 1;
                ...
                cell = new PdfPCell(new Paragraph("NIT/CC:      "+ conscabcera.nro_dgi2 + "-" + conscabcera.nro_dgi1, fontText1));
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 0;
                cell.BorderWidthLeft = 1;
                cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph("Direccion:   "+ conscabcera.dir_tit, fontText1));
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 0;
                cell.BorderWidthLeft = 1;
                cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph("Telefono:    "+ conscabcera.tel_tit, fontText1));
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 0;
                cell.BorderWidthLeft = 1;
                cell.BorderWidthBottom = 0;
                ...
                PdfPTable tablaCab2 = new PdfPTable(2); //tablas 3
                tablaCab2.WidthPercentage = 100;
                cell = new PdfPCell();

                cell = new PdfPCell(new Paragraph("Factura a aplicar:          " + conscabceraNC.observacion, fontText1));
                cell.BorderWidthTop = 1;
                cell.BorderWidthRight = 1;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph("Fecha Factura a aplicar: " + conscabceraNC.fec_doc_str, fontText1));
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 1;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph("Forma Pago:                 "+ conscabcera.nom_fpago, fontText1));
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 1;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph("Fecha Vto:                    "+ conscabcera.fec_venc_str, fontText1));
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 1;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthBottom = 0;
               ...
               // values[6] = 110;
                ...
                foreach (ModeloDetalleFactura item in listaConsDet)
                {
                    ...
                    detalle.DefaultCell.HorizontalAlignment = 2; detalle.AddCell(new Paragraph(ConsultaCMonedas.FormatorNumero(DecimalesMoneda.redondeo_pu, precio_un), fontText3));
