...
{
    public class PdfFacEleV3Default6
    {
        ...
        string metodo = "PdfFacEleV3Default6.cs";
        ...
        public string generarPdf(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans)
        {
            try
            {
             ...
             //   pw.PageEvent = new HeaderFooter();
                ...
                cell = new PdfPCell(new Phrase("Resolución Facturación Electrónica N°." + resolucion.cod_atrib1, fontText2)); //6 tamaño
                cell.Border = 0;
...
/*
               ...
               // cell.Colspan = 2;
                ...
                cell = new PdfPCell(new Phrase("FACTURA ELECTRÓNICA DE VENTA ",tipo2));
