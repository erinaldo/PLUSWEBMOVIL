        ...
        public string generarPdf(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans)
        {
            try
            {
             ...
             //   pw.PageEvent = new HeaderFooter();
                ...
                cell = new PdfPCell(new Phrase("Resolución Facturación N°." + resolucion.cod_atrib1, fontText2)); //7 tamaño
                cell.Border = 0;
                cell.HorizontalAlignment = 0;
                TabImg.AddCell(cell);

                cell = new PdfPCell(new Phrase("Vigencia " + resolucion.meses + " meses desde " + resolucion.fec_emision + " hasta " + resolucion.fec_caducidad, fontText2)); //7 tamaño
                cell.Border = 0;
                cell.HorizontalAlignment = 0;
                TabImg.AddCell(cell);

                cell = new PdfPCell(new Phrase("Habilita el prefijo " + resolucion.prefijo.Trim() + " desde " + resolucion.nro_docum + " hasta " + resolucion.nro_docum_ref, fontText2)); //7 tamaño
                cell.Border = 0;
                cell.HorizontalAlignment = 0;
                TabImg.AddCell(cell);
                ...
                cell = new PdfPCell(new Phrase(Modeloempresa.nom_emp, tipo2));
                cell.Border = 0;
                cell.HorizontalAlignment = 0;
                tabladetaEmpresa.AddCell(cell);

                cell = new PdfPCell(new Phrase("NIT: " + Modeloempresa.nro_dgi2 + "-" + Modeloempresa.nro_dgi1, fontText1));
                cell.Border = 0;
                cell.HorizontalAlignment = 0;
                tabladetaEmpresa.AddCell(cell);

                cell = new PdfPCell(new Phrase(ModelosucursalEmpresa.dir_sucursal, fontText1)); 
                cell.Border = 0;
                cell.HorizontalAlignment = 0;
                tabladetaEmpresa.AddCell(cell);
              

                cell = new PdfPCell(new Phrase(ModelosucursalEmpresa.nom_ciudad, fontText1));
                cell.Border = 0;
                cell.HorizontalAlignment = 0;
                tabladetaEmpresa.AddCell(cell);


                cell = new PdfPCell(new Phrase(ModelosucursalEmpresa.tel_sucursal + "-" + Modeloempresa.fax_tit, fontText1));
                cell.Border = 0;
                cell.HorizontalAlignment = 0;
                tabladetaEmpresa.AddCell(cell);


                cell = new PdfPCell(new Phrase(ModelosucursalEmpresa.email_sucursal, fontText3));//9
                cell.Border = 0;
                cell.HorizontalAlignment = 0;
                tabladetaEmpresa.AddCell(cell);

             /*   cell = new PdfPCell(new Phrase("Resolución Facturación N°." + resolucion.cod_atrib1, fontText3)); //7 tamaño
                cell.Border = 0;
                cell.HorizontalAlignment = 0;
                tabladetaEmpresa.AddCell(cell);
                ...
                cell = new PdfPCell(new Phrase("FACTURA  DE VENTA ", tipo2));
             ...
             /*   cell = new PdfPCell(new Phrase(" "));
                ...
                cell = new PdfPCell(new Phrase("Nro. " + resolucion.prefijo + " - " + conscabcera.nro_docum, titulo));//10 bold
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 1;
                cell.BorderWidthLeft = 1;
                cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph("ESTADO DIAN: APROBADO", fontText3)); //LETRA 7
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 1;
                cell.BorderWidthLeft = 1;
                cell.BorderWidthBottom = 0;
             ...
             /*   cell = new PdfPCell(new Phrase(" "));
                ...
                cell = new PdfPCell(new Paragraph("FECHA GENERACIÓN: " + fecha_gene, fontText3)); //LETRA 7 FECHA HORA AUTORIZACION DIAN
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 1;
                cell.BorderWidthLeft = 1;
                cell.BorderWidthBottom = 1;
               ...
               // value[5] = 80;
                ...
                cell = new PdfPCell(new Paragraph("Medio Pago:", fontText1));
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 0;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph("O.Compra:", fontText1));
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 0;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph("N° Pedido:", fontText1));
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 0;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph(modeloPagosPgs.nom_fpago, fontText1));//MEDIOS DE PAGO
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 1;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthBottom = 0;
                ...
                {
                    cell = new PdfPCell(new Paragraph(conscabcera.ocompra, fontText1));
                    cell.BorderWidthTop = 0;
                    cell.BorderWidthRight = 1;
                    cell.BorderWidthLeft = 0;
                    cell.BorderWidthBottom = 0;
                ...
                {
                    cell = new PdfPCell(new Paragraph(conscabcera.nro_pedido, fontText1));
                    cell.BorderWidthTop = 0;
                    cell.BorderWidthRight = 1;
                    cell.BorderWidthLeft = 0;
                    cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph("DESCUENTOS Y RECARGOS GLOBALES", titulo1));
                cell.BorderWidthBottom = 1;
                cell.BorderWidthLeft = 1;
                cell.BorderWidthTop = 1;
                cell.BorderWidthRight = 1;
               ...
               // total1.SpacingAfter = 10;
                ...
                cell = new PdfPCell(new Paragraph("IMPUESTOS, RETENCIONES", titulo1));
                cell.BorderWidthBottom = 1;
                cell.BorderWidthLeft = 1;
                cell.BorderWidthTop = 1;
                cell.BorderWidthRight = 1;
                ...
                cell = new PdfPCell(new Paragraph("TOTALES ", titulo1));
                cell.BorderWidthBottom = 1;
                cell.BorderWidthLeft = 0;
                cell.BorderWidthTop = 0;
                cell.BorderWidthRight = 0;
                ...
                PdfPTable infotri = new PdfPTable(1);//cantidad de columnas que va tener la tabla
