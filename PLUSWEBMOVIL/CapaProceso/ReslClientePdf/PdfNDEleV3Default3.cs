...
{
    public class PdfNDEleV3Default3
    {
        ...
        string metodo = "PdfNDEleV3Default3.cs";
        ...
        public string generarPdf(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans)
        {
            try
            {
             ...
             //   pw.PageEvent = new HeaderFooter();
                ...
                cell = new PdfPCell(new Phrase("Resolución Nota Débito Electrónica N°." + resolucion.cod_atrib1, fontText4)); //7 tamaño
                cell.Border = 0;
                ...
                cell = new PdfPCell(new Phrase("NOTA DÉBITO ELECTRÓNICA ", titulo1));
                ...
                cell = new PdfPCell(new Paragraph("Nota de Débito emitida por Factura1 SAS, NIT:900875062-6   Software: SDB-F1 ", fontText2));
                cell.Border = 0;
                cell.HorizontalAlignment = 0;
                infotri1.AddCell(cell);
