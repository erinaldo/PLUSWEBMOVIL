...
namespace CapaProceso.FacturaMasiva
{
    public class MasivoNCFinanciera
    {
        ...
        public string ProcesarNotaCreditoFinanciera(string Ccf_usuario, string Ccf_cod_emp, string nro_docum, string serie,  string cod_suc_emp)
        {
            try
            {
                string error = null;
                List<modeloFacturaEMasiva> lista = new List<modeloFacturaEMasiva>();
                 ...
                 lista = BuscarNCFinancieraXDocum(Ccf_usuario, Ccf_cod_emp, nro_docum, serie);

                //Insertar en la cabecera de nc
                error = InsertarCabecera(Ccf_usuario, Ccf_cod_emp, nro_docum, serie, lista, cod_suc_emp);
        ...
        public string  InsertarCabecera(string AmUsrLog, string ComPwm, string nro_docum, string serie, List<modeloFacturaEMasiva> lista, string cod_sucursal)
        {
            try
            {
                string error = null;
        ...
        //Total de nc financieras a procesar mandar tipo es decir normales o electronicas
        public List<modeloFacturaEMasiva> BuscarNCFinancieraXDocum(string ArtB__usuario, string ArtB__cod_emp, string nro_docum, string prefijo)
        {
            try
            {
                ...
                using (cn = conexion.genearConexionERP(stringConexionERP))
                {
                    ...
                    string consulta = "SELECT * from wmh_cargaMasiva where estado_fac ='A' and nro_docum =@nro_docum and serie_docum = @serie_docum";
                    SqlCommand conmand = new SqlCommand(consulta, cn);
        ...
        public string ActualizarEstadoNCF(string ArtB__usuario, string ArtB__cod_emp, string nro_docum,string prefijo, string estado_fac)
        {
            try
            {
                ...
                using (cn = conexion.genearConexionERP(stringConexionERP))
                {
                    ...
                    string consulta = "UPDATE wmh_cargaMasiva SET estado_fac=@estado_fac WHERE nro_docum =@nro_docum and serie_docum=@serie_docum AND estado_fac='A' ";
                    SqlCommand conmand = new SqlCommand(consulta, cn);
