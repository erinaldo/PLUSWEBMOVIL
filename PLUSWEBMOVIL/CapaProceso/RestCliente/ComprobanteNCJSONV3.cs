...
namespace CapaProceso.RestCliente
{
    ...
    {
        public List<DetalleNCV3> detalle { get; set; }
        public EncabezadoNCV3 encabezado { get; set; }
        public List<ConceptoNCV3> concepto { get; set; }
        public List<ImpuestoNCV3> impuesto { get; set; }
        public SucursalNCV3 sucursal { get; set; }
        public TerceroNCV3 tercero { get; set; }
    }

    public class ComprobanteNCJSONV3
    {
        public DocumentoNCV3 documento { get; set; }
    }
}
