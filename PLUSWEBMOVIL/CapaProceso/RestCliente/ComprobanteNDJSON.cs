...
{
   public class ComprobanteNDJSON
    {
        public DocumentoND documento { get; set; }

    }
    public class DetalleNDV2
    {
    ...
    {
        public List<DetalleNDV2> detalle { get; set; }
        public EncabezadoNDV2 encabezado { get; set; }
        public List<ImpuestoNDV2> impuesto { get; set; }
        public SucursalNDV2 sucursal { get; set; }
        public TerceroNDV2 tercero { get; set; }
    }
