...
{
    public class JsonNCFinancieraElectronicaV2
    {
        ...
        string metodo = "JsonNCFinancieraElectronicaV2.cs";
        public ComprobanteNCJSONV2 LlenarJSONNC(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans, string nro_factura)
        {
            try
            {
                ComprobanteNCJSONV2 comprobanteNCJSON = new ComprobanteNCJSONV2();
                DocumentoNCV2 documento = new DocumentoNCV2();
        ...
        public EncabezadoNCV2 LlenarEnacabezadoNCJSON(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans, string nro_factura)
        {
            try
            {
                string tipoFactura = "";
        ...
        public List<DetalleNCV2> LlenarDetalleNCJSON(string Ccf_cod_emp, string Ccf_usuario, string Ccf_nro_trans)
        {

            try
            {
                listaConsDet = ConsultaDeta.ConsultaDetalleFacura(Ccf_nro_trans);
                List<DetalleNCV2> detalle = new List<DetalleNCV2>();
                ModeloCotizacion = null;
                ModeloCotizacion = BuscarCotizacion(Ccf_usuario, Ccf_cod_emp, Ccf_nro_trans);

                foreach (var item in listaConsDet)
                {
                    DetalleNCV2 itemDetalle = new DetalleNCV2();
        ...
        public List<ImpuestoNCV2> LlenarImpuestoNCJSON(string Ccf_cod_emp, string Ccf_usuario, string Ccf_nro_trans, string impuesto_rest)
        {
            try
            {
                List<ImpuestoNCV2> impuesto = new List<ImpuestoNCV2>();
                ImpuestoNCV2 item = new ImpuestoNCV2();
        ...
        public SucursalNCV2 LlenarSucursalNCJSON(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans)
        {
            try
            {
                SucursalNCV2 sucursal = new SucursalNCV2();
                TerceroNCV2 tercero = new TerceroNCV2();
        ...
        public TerceroNCV2 LlenarTerceroNCJSON(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans)
        {
            try
            {
                TerceroNCV2 tercero = new TerceroNCV2();
