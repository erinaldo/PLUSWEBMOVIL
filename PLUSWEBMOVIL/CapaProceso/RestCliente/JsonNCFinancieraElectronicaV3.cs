...
{
    public class JsonNCFinancieraElectronicaV3
    {
        ...
        string metodo = "JsonNCFinancieraElectronicaV3.cs";
        public ComprobanteNCJSONV3 LlenarJSONNC(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans, string nro_factura)
        {
            try
            {
                ComprobanteNCJSONV3 comprobanteNCJSON = new ComprobanteNCJSONV3();
                DocumentoNCV3 documento = new DocumentoNCV3();
        ...
        public EncabezadoNCV3 LlenarEnacabezadoNCJSON(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans, string nro_factura)
        {
            try
            {
                string tipoFactura = "";
                EncabezadoNCV3 encabezado = new EncabezadoNCV3();
        ...
        public List<ConceptoNCV3> LlenarConceptoNCJSON(string Ccf_cod_emp, string Ccf_usuario, string Ccf_nro_trans)
        {
            try
            {
                ListaDesc = null;
                ListaDesc = consultaDesc.ConsultaDescCargTrans(Ccf_cod_emp, Ccf_usuario, Ccf_nro_trans);
                List<ConceptoNCV3> concepto = new List<ConceptoNCV3>();
                ModeloCotizacion = null;
                ModeloCotizacion = BuscarCotizacion(Ccf_usuario, Ccf_cod_emp, Ccf_nro_trans);

                foreach (var item in ListaDesc)
                {
                    ConceptoNCV3 itemDetalle = new ConceptoNCV3();
        ...
        public List<DetalleNCV3> LlenarDetalleNCJSON(string Ccf_cod_emp, string Ccf_usuario, string Ccf_nro_trans)
        {

            try
            {
                listaConsDet = ConsultaDeta.ConsultaDetalleFacura(Ccf_nro_trans);
                List<DetalleNCV3> detalle = new List<DetalleNCV3>();
                ModeloCotizacion = null;
                ModeloCotizacion = BuscarCotizacion(Ccf_usuario, Ccf_cod_emp, Ccf_nro_trans);

                foreach (var item in listaConsDet)
                {
                    DetalleNCV3 itemDetalle = new DetalleNCV3();
        ...
        public List<ImpuestoNCV3> LlenarImpuestoNCJSON(string Ccf_cod_emp, string Ccf_usuario, string Ccf_nro_trans, string impuesto_rest)
        {
            try
            {
                List<ImpuestoNCV3> impuesto = new List<ImpuestoNCV3>();
                ImpuestoNCV3 item = new ImpuestoNCV3();
        ...
        public SucursalNCV3 LlenarSucursalNCJSON(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans)
        {
            try
            {
                SucursalNCV3 sucursal = new SucursalNCV3();
                TerceroNCV3 tercero = new TerceroNCV3();
        ...
        public TerceroNCV3 LlenarTerceroNCJSON(string Ccf_cod_emp, string Ccf_usuario, string Ccf_tipo1, string Ccf_tipo2, string Ccf_nro_trans)
        {
            try
            {
                TerceroNCV3 tercero = new TerceroNCV3();
